...
<form class="admin-form" method="post" enctype="multipart/form-data"
      action="<?= $category ? site_url('admin/product-categories/' . $category->id . '/update') : site_url('admin/product-categories') ?>">
    <?= csrf_field() ?>
    ...
    <div class="form-actions">
        ...
        <a class="btn" href="<?= site_url('admin/product-categories') ?>">Cancel</a>
    </div>
</form>
<?= $this->endSection() ?>
